...
class CartPoleSupervisor(SupervisorCSV):
    ...
    def is_done(self):
        ...
        if ~all(x < 0.261799388 for x in poleAngle):
            return True

        cartPosition = [round(self.robot[i].getPosition()[2], 2) for i in range(9)]
