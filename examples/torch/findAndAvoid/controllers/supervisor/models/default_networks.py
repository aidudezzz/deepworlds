...
class DefaultCriticNetwork(nn.Module):
    def __init__(self,
                 lr,
                 input_dims,
                 fc1_dims,
        ...
        super(DefaultCriticNetwork, self).__init__()
...
class DefaultActorNetwork(nn.Module):
    def __init__(self,
                 lr,
                 input_dims,
                 fc1_dims,
                 ...
                 name,
                 chkpt_dir='./models/saved/default_ddpg/'):
        super(DefaultActorNetwork, self).__init__()
        self.lr = lr
        self.input_dims = input_dims
        self.fc1_dims = fc1_dims
        self.fc2_dims = fc2_dims
...
class DefaultDDPG(object):
    def __init__(self,
        ...
        self.actor = DefaultActorNetwork(
            lr_actor,
            input_dims,
            layer1_size,
            layer2_size,
        ...
        self.target_actor = DefaultActorNetwork(
            lr_actor,
            input_dims,
            layer1_size,
            layer2_size,
        ...
        self.critic = DefaultCriticNetwork(
            lr_critic,
            input_dims,
            layer1_size,
            layer2_size,
        ...
        self.target_critic = DefaultCriticNetwork(
            lr_critic,
            input_dims,
            layer1_size,
            layer2_size,
